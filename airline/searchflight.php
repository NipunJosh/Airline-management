		...
		{	
			if(isset($_POST['destination']) && !empty($_POST['destination']))
			{
				if(isset($_POST['date']) && !empty($_POST['date']))
				{
					...
					$date=$_POST['date'];
					$query=mysqli_query($con,("select ARRIVAL,DEPARTURE,DURATION,FLIGHT_CODE,AIRLINE_ID,PRICE_BUSINESS,PRICE_ECONOMY from flight where SOURCE='$source' && DESTINATION='$destination' && DATE='$date'"));
