	...
	if(isset($_POST['submit']))
	{
		...
		if(mysqli_num_rows($res)>0){
			...
			if(mysqli_num_rows($res)==0){
				...
				$sql5="insert into flight(SOURCE,DESTINATION,DEPARTURE,ARRIVAL,DURATION,FLIGHT_CODE,AIRLINE_ID,PRICE_BUSINESS,PRICE_ECONOMY,DATE) values('$source','$destination','$departure','$arrival','$duration','$flightcode','$airlinesid','$businessclass','$economyclass','$date')";
